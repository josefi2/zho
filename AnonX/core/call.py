    ...
    async def join_call(
        ...
        try:
            ...
            try:
                ...
                raise AssistantErr(
                    "**لم يتم العثور على محادثه صوتيه**\n\nتاكد من انك قمت ببدء المحادثه الصوتيه."
                )
        except AlreadyJoinedError:
            raise AssistantErr(
                "**الحساب المساعد موجود بالفعل في الدردشه الصوتيه**\n\nقام البوت برصد الحساب المساعد بانه موجود في الدردشه الصوتيه الرجاء اذا استمرت المشكله قم باغلاق الاتصال و  بدئه مره اخرى."
            )
        except TelegramServerError:
            raise AssistantErr(
                "**خطا في سيرفر التلغرام**\n\nقم باغلاق الحادثه الصوتيه و فتحها من جديد."
            )
