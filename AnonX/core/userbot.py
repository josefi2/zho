...
class Userbot(Client):
    ...
    async def start(self):
        ...
        if config.STRING1:
            ...
            try:
                await self.one.join_chat("ZHO_JOSEF")
                await self.one.join_chat("ISO_8")
            except:
                pass
            assistants.append(1)
        ...
        if config.STRING2:
            ...
            try:
                await self.two.join_chat("ZHO_JOSEF")
                await self.two.join_chat("ISO_8")
            except:
                pass
            assistants.append(2)
        ...
        if config.STRING3:
            ...
            try:
                await self.three.join_chat("ZHO_JOSEF")
                await self.three.join_chat("ISO_8")
            except:
                pass
            assistants.append(3)
