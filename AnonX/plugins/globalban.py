...
@app.on_message(command(["بنعال_جوج"]) & SUDOERS)
@language
async def gbanuser(client, message: Message, _):
    ...
    await message.reply_sticker("CAACAgIAAxkBAAEC61JkfyPIIp3ZEUH1mxOrikA-FBGFRQACVy0AAnv3-Ev0wq2OcRQXEy8E")
...
async def gungabn(client, message: Message, _):
    ...
    await message.reply_sticker("CAACAgIAAxkBAAEC61NkfyPKqXHU5KcRi1vzG6VQiWgVVAAC-CoAAr9M-UtOd7VTZprQgi8E")
    await message.reply_text(
